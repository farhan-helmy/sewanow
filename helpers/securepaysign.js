...
const signChecksum = async (tenant) => {
  ...
  const callback_url = "http://dev.sewanow.com/transaction_securepay/callback"
  ...
  const info = tenant.email + "|" + tenant.name + "|" + "" + "|" + callback_url + "|" + "1234" + "|" + "topup" + "|" + "https://sewanow.com/tenant/wallet" + "|" + tenant.amount + "|" + uid
