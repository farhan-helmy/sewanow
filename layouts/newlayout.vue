<template>
  <div class="w-full h-full bg-gray-200">
    <div class="flex flex-no-wrap">
      ...
      >
        <div
          class="bg-gray-800 opacity-50 absolute h-full w-full lg:hidden"
                ...
                >
                  <div class="flex items-center">
                    ...
                    <a
                      ...
                      class="ml-2 xl:text-base md:text-2xl text-base"
                      >Dashboard</a
                    >
                  </div>
                </li>
            ...
            <div class="w-full">
              <div class="flex justify-center mb-4 w-full px-6">
                <div class="relative w-full">
                  <div
                    class="text-gray-600 absolute ml-4 inset-0 m-auto w-4 h-4"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="border-t border-gray-300">
                <div class="w-full flex items-center justify-between px-6 pt-1">
                  <div class="flex items-center">
                    ...
                    />
                    <p
                      class="md:text-xl text-gray-800 text-base leading-4 ml-2"
                    >
                      Jane Doe
                    </p>
                  </div>
                  <ul class="flex">
                    ...
                    <li
                      ...
                      class="cursor-pointer text-white pt-5 pb-3 pl-3"
                    >
                      <a
                        aria-label="open notifications"
                        href="javascript:void(0)"
                    ...
                    >
                      ...
                      >
                        <div class="flex items-center">
                          ...
                          <a href="javascript:void(0)" class="text-sm ml-2"
                            >My Profile</a
                          >
                        </div>
                      </li>
